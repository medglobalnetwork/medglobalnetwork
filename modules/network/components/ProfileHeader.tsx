...
export function ProfileHeader({
  ...
  return (
    <div className="relative rounded-3xl bg-white shadow-sm border border-[#e8e6e3] overflow-hidden mb-6">
      {/* 1. Panoramic Mountain Cover Image with Overlay Quote */}
      <div className="relative h-48 sm:h-64 lg:h-72 w-full overflow-hidden bg-gradient-to-r from-teal-900 via-emerald-800 to-cyan-900">
        <img
          src={coverUrl}
          alt="Profile Cover"
        ...
        {quoteText && (
          <div className="absolute top-4 left-6 sm:top-6 sm:left-8 max-w-md hidden xs:block">
            <div className="inline-flex items-center gap-2 rounded-full bg-black/40 backdrop-blur-md px-3.5 py-1.5 border border-white/15 text-xs text-white/95 font-medium tracking-wide shadow-lg">
        ...
        {isOwnProfile && (
          <div className="absolute top-4 right-4 sm:top-6 sm:right-6">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full bg-white/20 backdrop-blur-md px-3.5 py-1.5 text-xs font-semibold text-white border border-white/30 transition-all hover:bg-white/30 hover:scale-105 active:scale-95 shadow-md"
            >
      ...
      <div className="px-5 sm:px-8 pb-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 -mt-16 sm:-mt-20 mb-5">
          {/* Avatar with Teal Ring & Online Dot */}
          <div className="flex items-end gap-4">
            <div className="relative group">
              <div className="relative h-28 w-28 sm:h-36 sm:w-36 rounded-full p-1 bg-white shadow-xl ring-4 ring-cyan-500/80">
                <div
                  className="h-full w-full rounded-full overflow-hidden flex items-center justify-center text-3xl font-extrabold text-white"
              ...
              <span
                className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 h-4 w-4 sm:h-5 sm:w-5 rounded-full bg-emerald-500 ring-4 ring-white shadow-md"
            ...
            <div className="md:hidden pb-1">
              <div className="flex items-center gap-1.5">
                ...
                <CheckCircle2 className="h-5 w-5 text-blue-500 fill-blue-500 text-white shrink-0" />
              </div>
              <p className="text-xs font-medium text-[#5d5854] line-clamp-1">
            ...
            {isOwnProfile ? (
              <>
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-[#1769c2] px-4 py-2.5 text-xs font-bold text-white shadow-sm transition hover:bg-[#12569f] active:scale-95"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-[#ded8d1] bg-white px-4 py-2.5 text-xs font-semibold text-[#5d5854] shadow-xs transition hover:bg-[#f8f7f6] active:scale-95"
                >
                  <Stethoscope className="h-4 w-4 text-[#1769c2]" />
                  <span>Know More</span>
                </button>
                <button
                  type="button"
                  onClick={onShareClick}
                  className="inline-flex items-center justify-center h-9 w-9 rounded-xl border border-[#ded8d1] bg-white text-[#5d5854] transition hover:bg-[#f8f7f6] active:scale-95"
                  title="Share Profile"
                >
              ...
              <>
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-xl border px-4 py-2.5 text-xs font-bold transition active:scale-95 disabled:opacity-50 ${
                    isFollowing
                ...
                <button
                  type="button"
                  onClick={onOpenKnowMore}
                  className="inline-flex items-center gap-1.5 rounded-xl border border-[#ded8d1] bg-[#f8f7f6] px-3.5 py-2.5 text-xs font-semibold text-[#5d5854] hover:bg-[#f0efee] active:scale-95"
                >
                  <span>Know More</span>
                </button>
                <button
                  type="button"
                  onClick={onShareClick}
                  className="inline-flex items-center justify-center h-9 w-9 rounded-xl border border-[#ded8d1] bg-white text-[#5d5854] transition hover:bg-[#f8f7f6]"
                >
                  <Share2 className="h-4 w-4" />
                </button>
              </>
        ...
        <div className="space-y-3">
          <div className="hidden md:block">
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-black text-[#171717] tracking-tight">{profile.name}</h1>
              <CheckCircle2 className="h-6 w-6 text-blue-500 fill-blue-500 text-white" />
              {isVerified && (
            ...
            <p className="mt-1 text-sm font-semibold text-[#5d5854]">
