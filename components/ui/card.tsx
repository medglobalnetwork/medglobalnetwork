...
// Variants
const cardVariants = cva('flex flex-col items-stretch text-card-foreground rounded-2xl', {
  variants: {
    variant: {
      default: 'bg-card border border-border shadow-xs',
      accent: 'bg-muted shadow-xs p-1 border border-border',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const cardContentVariants = cva('grow p-5', {
  variants: {
    variant: {
      default: '',
      accent: 'bg-card rounded-xl [&:last-child]:rounded-xl p-4',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const cardFooterVariants = cva('flex items-center px-5 min-h-14', {
  variants: {
    variant: {
      ...
      accent: 'bg-card rounded-xl mt-1 px-4 py-3',
    },
  },
  defaultVariants: {
    variant: 'default',
